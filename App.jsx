...
export default function NJProCleaningWebsite() {
  ...
  // ✅ Put your images in: /public/work/ and /public/logo.svg (or logo.png)
  const workImages = useMemo(
    () => [
      { src: "/work/gym-weights-1.jpg", alt: "Gym cleaning - equipment floor area", tag: "Gym & Fitness" },
      { src: "/work/gym-lounge-1.jpg", alt: "Gym cleaning - lounge area", tag: "Gym & Fitness" },
      { src: "/work/office-tiles-1.jpg", alt: "Office cleaning - polished tiled floor", tag: "Office" },
      { src: "/work/venue-carpet-1.jpg", alt: "Venue cleaning - carpeted area", tag: "Hospitality" },
      { src: "/work/venue-floor-1.jpg", alt: "Hospitality cleaning - polished floor", tag: "Hospitality" },
      { src: "/work/restroom-black-tiles-1.jpg", alt: "Bathroom cleaning - black tiled restroom", tag: "Bathrooms" },
      { src: "/work/restroom-sinks-1.jpg", alt: "Bathroom cleaning - sinks and mirrors", tag: "Bathrooms" },
      { src: "/work/office-reception-1.jpg", alt: "Office cleaning - reception and floor finish", tag: "Office" },
      { src: "/work/window-clean-1.jpg", alt: "Window cleaning - exterior pole system", tag: "Windows" },
      { src: "/work/window-clean-2.jpg", alt: "Window cleaning - finished exterior window", tag: "Windows" },
      { src: "/work/gym-cardio-1.jpg", alt: "Gym cleaning - cardio area", tag: "Gym & Fitness" },
      { src: "/work/office-carpet-1.jpg", alt: "Office carpet cleaning - extraction", tag: "Carpet" },
      { src: "/work/office-carpet-2.jpg", alt: "Office carpet cleaning - conference room", tag: "Carpet" },
    ],
    []
  );
  ...
  useEffect(() => {
    const needsElfsight =
      ...
      (ELSFIGHT_GOOGLE_REVIEWS_APP && !ELSFIGHT_GOOGLE_REVIEWS_APP.includes("YOUR_"));
      ...
      <div className="font-sans text-gray-200 bg-slate-800">
        ...
        <header className="bg-slate-900 shadow-md fixed w-full z-50">
          <div className="max-w-7xl mx-auto flex justify-between items-center p-4">
            <div className="flex items-center gap-3">
              <img src="/logo.svg" alt="NJ Pro Cleaning Services Logo" className="h-12 w-auto" />
            ...
            <nav className="space-x-6 hidden md:block">
              ...
              <a href="#work" className="hover:text-amber-400">Our Work</a>
              <a href="#social" className="hover:text-amber-400">Reviews</a>
              <a href="#industries" className="hover:text-amber-400">Industries</a>
              <a href="#about" className="hover:text-amber-400">About</a>
              <a href="#contact" className="bg-amber-500 text-slate-900 px-4 py-2 rounded-2xl shadow-lg font-semibold">
                Get Quote
              </a>
        ...
        <section className="pt-32 pb-24 text-center bg-slate-800">
          ...
          <p className="max-w-2xl mx-auto mb-8 text-lg text-gray-300">
            Quality matters. We deliver detail-focused cleaning for offices, gyms, hospitality venues, bathrooms,
            carpets and windows.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="#contact" className="bg-amber-500 text-slate-900 px-8 py-4 rounded-2xl text-lg shadow-xl font-semibold">
              Book Free Site Inspection
            </a>
            <a href="#work" className="border border-amber-500 text-amber-400 px-8 py-4 rounded-2xl text-lg shadow font-semibold">
              See Our Results
            </a>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-gray-300 max-w-3xl mx-auto">
                Real results from commercial sites — polished floors, restored carpets, spotless bathrooms and
                streak-free windows.
              </p>
            </div>
                        ...
                        e.currentTarget.src = "data:image/svg+xml;charset=utf-8," + encodeURIComponent(
                          `<svg xmlns='http://www.w3.org/2000/svg' width='1200' height='800'>
                            ...
                            <text x='50%' y='50%' dominant-baseline='middle' text-anchor='middle'
                              font-family='Arial' font-size='42' fill='#f59e0b'>Add photo: ${img.src}</text>
                          </svg>`
                        );
                      }}
                    />
            ...
            <AnimatePresence>
              {lightboxIndex >= 0 && filtered[lightboxIndex] && (
                ...
                >
                  ...
                  >
                    <button onClick={close} className="absolute -top-12 right-0 text-white/90 hover:text-white flex items-center gap-2">
                      <X size={18} /> Close
                    </button>
                    ...
                    <div className="bg-slate-950 rounded-2xl overflow-hidden shadow-2xl">
                      ...
                      <div className="p-4 flex items-center justify-between gap-3">
                        <div>
                          <p className="text-white font-semibold">{filtered[lightboxIndex].alt}</p>
                          <p className="text-gray-400 text-sm">{filtered[lightboxIndex].tag}</p>
                        </div>
                        <div className="flex gap-2">
                          <button onClick={prev} className="px-4 py-2 rounded-2xl border border-slate-700 text-gray-200 hover:border-amber-500 hover:text-amber-400">
                            <span className="inline-flex items-center gap-2"><ChevronLeft size={16} /> Prev</span>
                          </button>
                          <button onClick={next} className="px-4 py-2 rounded-2xl border border-slate-700 text-gray-200 hover:border-amber-500 hover:text-amber-400">
                            <span className="inline-flex items-center gap-2">Next <ChevronRight size={16} /></span>
                          </button>
                        </div>
                      </div>
                    </div>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="mt-12">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-8">Live feed from @njprocleaningservices.</p>
              </div>
            ...
            <div className="mt-12">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-8">Official Facebook Page plugin with timeline and messages.</p>
              </div>
              <div className="bg-slate-950 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl">
                <iframe
                  ...
                  src={
                    ...
                    "href=" + encodeURIComponent(FACEBOOK_PAGE_URL) +
            ...
            <div className="mt-12">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-8">Live Google reviews from your Business Profile (via widget).</p>
              </div>
            ...
            <div className="mt-12">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-8">Service area: Perth and surrounds.</p>
              </div>
              <div className="bg-slate-950 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl">
                <iframe
        ...
        <section id="industries" className="py-20 bg-slate-800">
          <div className="max-w-6xl mx-auto text-center px-4">
            <h3 className="text-3xl font-bold mb-12 text-amber-400">Industries We Service</h3>
            <div className="grid md:grid-cols-4 gap-8">
              {["Corporate Offices", "Medical Centres", "Gyms & Fitness", "Hospitality Venues"].map((industry, index) => (
                <div key={index} className="p-6 border border-amber-500 rounded-2xl shadow-md bg-slate-900">
        ...
        <section className="bg-slate-900 py-20">
          <div className="max-w-6xl mx-auto text-center px-4">
            <h3 className="text-3xl font-bold mb-12 text-amber-400">Why Choose NJ Pro Cleaning?</h3>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-6"><ShieldCheck className="mx-auto mb-4 text-amber-400" /><p>Fully insured and police-cleared staff</p></div>
              <div className="p-6"><ClipboardCheck className="mx-auto mb-4 text-amber-400" /><p>Strict quality control inspections</p></div>
              <div className="p-6"><CheckCircle className="mx-auto mb-4 text-amber-400" /><p>Flexible after-hours cleaning</p></div>
            </div>
          </div>
        </section>
        ...
        <section id="about" className="py-20 bg-slate-800">
          <div className="max-w-4xl mx-auto text-center px-4">
            <h3 className="text-3xl font-bold mb-6 text-amber-400">About NJ Pro Cleaning Services</h3>
            <p className="text-gray-300">
              Perth-based commercial cleaning specialists delivering premium, consistent results.
              We focus on compliance, hygiene standards, structured quality checks and clear communication.
            </p>
          </div>
        </section>
        ...
        <section id="contact" className="bg-slate-950 text-white py-20">
          <div className="max-w-4xl mx-auto text-center px-4">
            <h3 className="text-3xl font-bold mb-6 text-amber-400">Request a Free Quote</h3>
            ...
            >
              ...
              <input type="hidden" name="subject" value="New Quote Request - NJ Pro Cleaning" />

              <input name="company" required type="text" placeholder="Company Name" className="p-3 rounded" />
              <input name="contact" required type="text" placeholder="Contact Person" className="p-3 rounded" />
              <input name="email" required type="email" placeholder="Email" className="p-3 rounded" />
              <input name="phone" required type="tel" placeholder="Phone" className="p-3 rounded" />
              <textarea name="message" required placeholder="Tell us about your premises (sqm, frequency, suburb/address)" className="p-3 rounded" rows={4} />
            ...
            <div className="mt-8 text-gray-300">
              <p className="flex justify-center items-center gap-2"><Phone size={18} /> {SITE.phone}</p>
              <p className="flex justify-center items-center gap-2"><Mail size={18} /> {SITE.email}</p>
        ...
        <footer className="bg-black text-gray-400 text-center p-6">
          <p>© {new Date().getFullYear()} NJ Pro Cleaning Services | Perth Commercial Cleaning Specialists</p>
        </footer>
      </div>
    </HelmetProvider>
  );
